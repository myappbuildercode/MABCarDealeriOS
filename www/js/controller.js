...
function sharePhoto() {
    ...
    navigator.screenshot.save(function(error,res){
                              ...
                              window.plugins.socialsharing.shareViaEmail(
                                                                         ...
                                                                         function(){console.log('share ok')}, function(msg) {console.log('error: ' + msg)}
                                                                         );
                              }
                              },'jpg',50,'myScreenShot');
}
                            ...
                            .success(function(data, status){
                                     ...
                                     .success(function(reskey){
                                              ...
                                              .error(function(error, status) {
                                                     $ionicLoading.hide();
                                                   //  navigator.notification.alert(error.error, function(){}, 'Car Dealers', 'OK' );
                                                     });
                                              }
                                              }
...
control.controller('registerCtrl',function($scope,$state,$ionicLoading,$ionicPopup,$ionicModal,$ionicScrollDelegate,$ionicActionSheet){
                   ...
                   $.ajax({
                          ...
                          if(response1[j].key=="AppType" && response1[j].value=="Car Dealers"){
...
control.controller('addBookCtrl',function($scope, $state,$ionicPopup,$ionicLoading,$ionicScrollDelegate,$http, $ionicActionSheet){
                   ...
                   navigator.notification.alert("Enter Social Share URL", function(){}, 'Car Dealers', 'OK' );
                   }
                   }else{
                   navigator.notification.alert("Select Car Dealers Image & Enter Car Dealers Title", function(){}, 'Car Dealers', 'OK' );
                   }
                   }
...
//                                              $state.go('addElement');
                   ...
                   navigator.notification.alert('Please Enter Your Content Title!',alertDismissed,'Content','done');
                   }
                   ...
                   $.ajax({
                          ...
                          $.ajax({
                                 ...
                                 $.ajax({
                                        ...
                                        navigator.notification.alert('Selected contact(s) has been added succesfully!',function(){$scope.agentModal.hide();},chapterTitle,'Done');
                                        },
                                        error:function(error,status){
                                        window.wizSpinner.hide();
                                        var error = JSON.parse(error.responseText);
                   ...
                   if($scope.contentCreate.elementTag==''){
                   amenities='';
                   }
                   else{
                   ...
                   $.ajax({
                          ...
                          $.ajax({
                                 ...
                                 error:function(error,status){
                                 $ionicLoading.hide();
                                 navigator.notification.alert("error12233: "+error.responseText);
                                 }
                                 });
...
control.controller('agentsCtrl', function($scope,$state,$ionicModal,$ionicLoading,$ionicScrollDelegate,$ionicPopup,$http,$ionicSideMenuDelegate,$ionicActionSheet){
                   ...
                   $.ajax({
                          ...
                          window.wizSpinner.hide();
                          var error = JSON.parse(error.responseText);
                          navigator.notification.alert(error.error, function(){}, 'Agents', 'OK' );
                          }
                          });
                   });
...
control.controller('previewSubTitleCtrl',function($scope,$state,$ionicModal,$ionicLoading,$ionicScrollDelegate,$ionicPopup,$http,$ionicActionSheet){
                   ...
                   $.ajax({
                          ...
                          window.wizSpinner.hide();
                          var error = JSON.parse(error.responseText);
                          navigator.notification.alert(error.error, function(){}, 'Contents', 'OK' );
                          }
                          });
                   for (var i = 0; i < elementArray.length; i++) {
                   if(id == elementArray[i].id){
...
control.controller('addButtonCtrl',function($scope,$state,$ionicModal,$ionicLoading,$ionicScrollDelegate,$ionicPopup,$http,$ionicActionSheet){
                   ...
                   $ionicLoading.hide();
                   navigator.notification.alert("Enter New Listing Title and Image", function(){}, 'Car Dealers', 'OK' );
                   }
                   }
                   });
...
control.controller('editButtonCtrl',function($scope,$state,$ionicModal,$ionicPopup,$ionicLoading,$ionicScrollDelegate,$stateParams,$http,$ionicActionSheet){
                   ...
                   $ionicLoading.hide();
                   navigator.notification.alert("Enter New Listing Title", function(){}, 'Car Dealers', 'OK' );
                   }
                   }
...
control.controller('addElementCtrl',function($scope,$state,$ionicModal,$ionicPopup,$ionicLoading,$ionicScrollDelegate,$sce,$http,$ionicActionSheet){
                   ...
                   navigator.notification.alert("Please select an Agent", function(){}, 'Content', 'OK' );
                   }
...
control.controller('editBookCtrl',function($scope,$state,$ionicLoading,$ionicPopup,$ionicModal,$ionicScrollDelegate, $ionicActionSheet,$http){
                   ...
                   navigator.notification.alert("Enter Car Dealers Title & Enter Social Share URL", function(){}, 'Car Dealers', 'OK' );
                   }
                   }
                   });
